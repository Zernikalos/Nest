<template>
    <div class="flex">
        <FileSelector @update:file-selected="handleFileSelectedEvent"></FileSelector>
        <DropDownSelector :options="labelOptions" :selected="props.formatSelected" @update:selected="(ev) => $emit('update:formatSelected', ev)"></DropDownSelector>
    </div>
</template>
